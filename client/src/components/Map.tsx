...
export function MapView({
  ...
  if (mapError) {
    return (
      <div
        className={cn(
          "w-full h-[500px] flex items-center justify-center rounded-xl border border-border bg-secondary text-sm text-muted-foreground px-6 text-center",
          className
        )}
      >
        Map unavailable. Set VITE_GOOGLE_MAPS_API_KEY to enable Google Maps.
      </div>
    );
  }
